...
titles[7] = "The Good, the Bad and the Ugly (1994)";
titles[8] = "12 Angry Men (1957)";
titles[9] = "Inception (2010)";
...
summaries[7] = "A bounty hunting scam joins two men in an uneasy alliance against a third in a race to find a fortune in gold buried in a remote cemetery.";
summaries[8] = "A jury holdout attempts to prevent a miscarriage of justice by forcing his colleagues to reconsider the evidence.";
summaries[9] = "A thief who steals corporate secrets through the use of dream-sharing technology is given the inverse task of planting an idea into the mind of a CEO.";
...
links[7] = "https://www.imdb.com/title/tt0060196/?ref_=adv_li_tt";
...
for(var i = 0; i < 10; i++) {
   htmlCode += "<tr><td><a href='" +links[i] + "'> " + titles[i] + "</a></td><td>" + summaries[i] + 
   "</td><td>" + ratings[i] + "</td></tr>";
}
